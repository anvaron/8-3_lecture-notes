const { find } = require("./weather-data.js");
...
function daysWarmerThan50(forecast) {
    const findDaysWarmer = forecast.find(day => day.highTemp > 50)
    console.log(findDaysWarmer)
    return findDaysWarmer;
}

daysWarmerThan50(weatherData)
